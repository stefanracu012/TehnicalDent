...
const allNavLinks = [
  ...
  },
  {
    href: "/admin/whatsapp",
    label: "WhatsApp",
    // Brand glyphs are solid single-colour paths, so they inherit the nav's
    // currentColor like the outline icons around them.
    icon: (
  ...
  },
  {
    ...
    icon: (
      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        <path d="M12 0C5.373 0 0 4.974 0 11.111c0 3.498 1.744 6.614 4.469 8.652V24l4.086-2.242c1.09.301 2.246.464 3.445.464 6.627 0 12-4.974 12-11.111C24 4.974 18.627 0 12 0Zm1.193 14.963-3.056-3.259-5.963 3.259L10.732 8l3.13 3.259L19.752 8l-6.559 6.963Z" />
      </svg>
    ),
  },
  {
