    ...
    <>
      ...
      <aside className="hidden md:flex flex-col w-56 shrink-0 min-h-screen bg-foreground text-white">
        ...
        <div className="px-5 py-5 border-b border-white/10">
          <span className="font-serif text-lg font-semibold tracking-tight">TechnicalDent</span>
        ...
        <div className="flex h-13 items-center justify-between px-4">
          ...
          >
            <div className="w-5 h-4 relative flex flex-col justify-between">
              <span className={`block h-[2px] w-full bg-white rounded-full transition-all duration-300 origin-center ${mobileOpen ? "translate-y-[7px] rotate-45" : ""}`} />
              <span className={`block h-[2px] w-full bg-white rounded-full transition-all duration-200 ${mobileOpen ? "opacity-0 scale-x-0" : ""}`} />
              <span className={`block h-[2px] w-full bg-white rounded-full transition-all duration-300 origin-center ${mobileOpen ? "-translate-y-[7px] -rotate-45" : ""}`} />
            </div>
          </button>
          <span className="font-serif text-sm font-semibold">TechnicalDent Admin</span>
          <LogoutButton />
        </div>

        {/* Mobile dropdown */}
        <div className={`overflow-hidden transition-all duration-300 ${mobileOpen ? "max-h-[500px] border-t border-white/10" : "max-h-0"}`}>
          <nav className="px-3 py-3 space-y-0.5">
            ...
            <Link href="/" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-white/60 hover:text-white hover:bg-white/10">
              ← Vezi site-ul
            </Link>
          </nav>
        </div>
