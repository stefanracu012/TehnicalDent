...
async function main() {
  ...
  const teamMembers = [
    {
      ...
      isActive: true,
      translations: {
        en: { role: "Chief Dentist, Founder", description: "With over 20 years of experience in dentistry, Dr. Ionescu founded TehnicalDent with the vision of providing excellent dental services. Specialized in implantology and cosmetic dentistry, she is recognized for her attention to detail and personalized approach to each case." },
        ru: { role: "Главный стоматолог, Основатель", description: "С более чем 20-летним опытом работы в стоматологии, Dr. Ionescu основала TehnicalDent с целью предоставления стоматологических услуг высшего качества. Специализируясь на имплантологии и эстетической стоматологии, она известна вниманием к деталям и персонализированным подходом к каждому случаю." },
        it: { role: "Medico Primario Dentista, Fondatrice", description: "Con oltre 20 anni di esperienza in odontoiatria, Dr. Ionescu ha fondato TehnicalDent con la visione di offrire servizi odontoiatrici d'eccellenza. Specializzata in implantologia ed estetica dentale, è riconosciuta per l'attenzione ai dettagli e l'approccio personalizzato a ogni caso." },
      },
    },
    {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      isActive: true,
      translations: {
        en: { content: "At 62 years old, I thought my smile could no longer be restored. I had missing teeth and the remaining ones were in poor condition. The TehnicalDent team proposed a complex treatment plan, carried out in stages over 8 months. Today I have a complete, functional, and aesthetic smile. My gratitude is immense.", service: "Complete oral rehabilitation" },
        ru: { content: "В 62 года я думал, что моя улыбка уже не подлежит восстановлению. У меня были отсутствующие зубы, а оставшиеся находились в плохом состоянии. Команда TehnicalDent предложила комплексный план лечения, выполненный поэтапно в течение 8 месяцев. Сегодня у меня полноценная, функциональная и эстетичная улыбка. Моя благодарность безгранична.", service: "Полная реабилитация полости рта" },
        it: { content: "A 62 anni, pensavo che il mio sorriso non potesse più essere recuperato. Avevo denti mancanti e quelli rimasti erano in condizioni precarie. Il team TehnicalDent mi ha proposto un piano di trattamento complesso, realizzato per fasi nell'arco di 8 mesi. Oggi ho un sorriso completo, funzionale ed estetico. La mia gratitudine è immensa.", service: "Riabilitazione orale completa" },
      },
    },
    {
      name: "Ioana L.",
